...
*** Keywords ***
Deberı́a recibir un correo electronico con el enlace de confirmacion
...
Deberı́a ser redirigido a la pagina de inicio de sesion
...
Deberı́a recibir un error al intentar iniciar sesion
...
La informacion de la consulta "${TAG}" deberı́a contener el cliente con DNI "${DNI}"
...
La informacion de la consulta "${TAG}" deberı́a contener el campo "${KEY}" en "${VALUE}"
